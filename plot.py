...
plt.plot(auc[14], auc[15], label='roc curve of ADTEP')
plt.plot(auc[17], auc[18], label='roc curve of DTEP')
plt.plot(auc[20], auc[21], label='roc curve of LR')
plt.plot(auc[23], auc[24], label='roc curve of SVM')
plt.xlabel('False positive rate')
plt.ylabel('True positive rate')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
